...
function [polar_array, polar_noise] = normaliseiris(image, x_iris, y_iris, r_iris, x_pupil, y_pupil, r_pupil, radpixels, angulardiv)
...
mad = median(abs(polar_array(:)-median(polar_array(:))));
polar_array = (polar_array-median(polar_array(:)))/mad;
polar_array = rescale(polar_array);
